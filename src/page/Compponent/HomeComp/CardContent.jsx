    ...
    return (
        <div key={id} className="card bg-red-50 w-[8rem] h-[7.875rem] xl:w-[18.75rem] xl:h-[18.5rem] xl:rounded-3xl xl:p-5 p-2 rounded-xl">
            <div className=' xl:rounded-3xl w-full h-full'>
                ...
                <p className='font-poppins xl:text-sm text-[6px] text-cust-gray xl:w-full text-start xl:mt-4 mt-2'>{tanggal}</p>
                <h3 className='font-poppins xl:w-full text-start xl:mt-2 font-bold xl:text-lg text-[8px]'>{judul}</h3>
            </div>
        </div>
    );
};
